...
all() ->
    [simple_acl_list, simple_acl_file, spaces_acl_list, utf8_simple].
...
simple_acl_file(_) ->
    ...
    [[{[<<"a">>, <<"b">>, <<"c">>], 1}], [{[<<"v">>, <<"w x">>, <<"y">>], 1}]] =
        lists:sort(ets:match(vmq_acl_write_all, '$1')),
    [[{{<<"test">>, [<<"x">>, <<"y">>, <<"z">>, <<"#">>]}, 1}]] =
    ...
    {ok, _} = vmq_acl:auth_on_subscribe(
        <<"test">>,
        {"", <<"my-client-id">>},
        [
            {[<<"a">>, <<"b">>, <<"c">>], 0},
