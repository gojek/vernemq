...
-define(MQTT_DISONNECT, mqtt_disconnect).
-define(REASON_NOT_AUTHORIZED, 'REASON_NOT_AUTHORIZED').
-define(REASON_NORMAL_DISCONNECT, 'REASON_NORMAL_DISCONNECT').
-define(REASON_SESSION_TAKEN_OVER, 'REASON_SESSION_TAKEN_OVER').
-define(REASON_ADMINISTRATIVE_ACTION, 'REASON_ADMINISTRATIVE_ACTION').
-define(REASON_DISCONNECT_KEEP_ALIVE, 'REASON_DISCONNECT_KEEP_ALIVE').
-define(REASON_DISCONNECT_MIGRATION, 'REASON_DISCONNECT_MIGRATION').
-define(REASON_BAD_AUTHENTICATION_METHOD, 'REASON_BAD_AUTHENTICATION_METHOD').
-define(REASON_REMOTE_SESSION_TAKEN_OVER, 'REASON_REMOTE_SESSION_TAKEN_OVER').
-define(REASON_MQTT_CLIENT_DISCONNECT, 'REASON_MQTT_CLIENT_DISCONNECT').
-define(REASON_RECEIVE_MAX_EXCEEDED, 'REASON_RECEIVE_MAX_EXCEEDED').
-define(REASON_PROTOCOL_ERROR, 'REASON_PROTOCOL_ERROR').
-define(REASON_PUBLISH_AUTH_ERROR, 'REASON_PUBLISH_AUTH_ERROR').
-define(REASON_INVALID_PUBREC_ERROR, 'REASON_INVALID_PUBREC_ERROR').
-define(REASON_INVALID_PUBCOMP_ERROR, 'REASON_INVALID_PUBCOMP_ERROR').
-define(REASON_UNEXPECTED_FRAME_TYPE, 'REASON_UNEXPECTED_FRAME_TYPE').
-define(REASON_EXIT_SIGNAL_RECEIVED, 'REASON_EXIT_SIGNAL_RECEIVED').
...
-define(METRIC_CLUSTER_MSG_DROP, cluster_msg_drop).
