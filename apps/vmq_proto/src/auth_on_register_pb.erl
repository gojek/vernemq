...
-include("auth_on_register_pb.hrl").
-include("gpb.hrl").
...
%% message types
-type 'eventssidecar.v1.AuthOnRegister'() :: #'eventssidecar.v1.AuthOnRegister'{}.

-type 'google.protobuf.Timestamp'() :: #'google.protobuf.Timestamp'{}.

-export_type(['eventssidecar.v1.AuthOnRegister'/0, 'google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'eventssidecar.v1.AuthOnRegister' | 'google.protobuf.Timestamp'.
-type '$msg'() :: 'eventssidecar.v1.AuthOnRegister'() | 'google.protobuf.Timestamp'().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.AuthOnRegister' ->
            'encode_msg_eventssidecar.v1.AuthOnRegister'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
            'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.

'encode_msg_eventssidecar.v1.AuthOnRegister'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.AuthOnRegister'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.AuthOnRegister'(
    #'eventssidecar.v1.AuthOnRegister'{
        timestamp = F1,
        mountpoint = F2,
        client_id = F3,
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.AuthOnRegister_timestamp'(
...
'e_mfield_eventssidecar.v1.AuthOnRegister_timestamp'(Msg, Bin, TrUserData) ->
...
decode_msg_2_doit('eventssidecar.v1.AuthOnRegister', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.AuthOnRegister'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.AuthOnRegister'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    ...
    'd_field_eventssidecar.v1.AuthOnRegister_timestamp'(
...
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    ...
    'd_field_eventssidecar.v1.AuthOnRegister_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
) ->
    'd_field_eventssidecar.v1.AuthOnRegister_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    <<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
) ->
    'd_field_eventssidecar.v1.AuthOnRegister_peer_addr'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    <<40, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
) ->
    'd_field_eventssidecar.v1.AuthOnRegister_peer_port'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    <<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
) ->
    'd_field_eventssidecar.v1.AuthOnRegister_username'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    <<56, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
) ->
    'd_field_eventssidecar.v1.AuthOnRegister_clean_session'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
...
'dfp_read_field_def_eventssidecar.v1.AuthOnRegister'(
    ...
    'dg_read_field_def_eventssidecar.v1.AuthOnRegister'(
        Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
    ).
...
'dg_read_field_def_eventssidecar.v1.AuthOnRegister'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_eventssidecar.v1.AuthOnRegister'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
                    );
                1 ->
                    'skip_64_eventssidecar.v1.AuthOnRegister'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
                    );
                2 ->
                    'skip_length_delimited_eventssidecar.v1.AuthOnRegister'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
                    );
                3 ->
                    'skip_group_eventssidecar.v1.AuthOnRegister'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
                    );
                5 ->
                    'skip_32_eventssidecar.v1.AuthOnRegister'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, TrUserData
                    )
            end
    end;
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.AuthOnRegister' ->
            'merge_msg_eventssidecar.v1.AuthOnRegister'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
            'merge_msg_google.protobuf.Timestamp'(Prev, New, TrUserData)
    end.

-compile({nowarn_unused_function, 'merge_msg_eventssidecar.v1.AuthOnRegister'/3}).
'merge_msg_eventssidecar.v1.AuthOnRegister'(
    #'eventssidecar.v1.AuthOnRegister'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.AuthOnRegister' ->
            'v_msg_eventssidecar.v1.AuthOnRegister'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
-compile({nowarn_unused_function, 'v_msg_eventssidecar.v1.AuthOnRegister'/3}).
-dialyzer({nowarn_function, 'v_msg_eventssidecar.v1.AuthOnRegister'/3}).
'v_msg_eventssidecar.v1.AuthOnRegister'(
    #'eventssidecar.v1.AuthOnRegister'{
        timestamp = F1,
        mountpoint = F2,
        client_id = F3,
    ...
    ok;
'v_msg_eventssidecar.v1.AuthOnRegister'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.AuthOnRegister'}, X, Path).
...
get_msg_defs() ->
    [
        {{msg, 'eventssidecar.v1.AuthOnRegister'}, [
            #field{
                name = timestamp,
                fnum = 1,
                rnum = 2,
...
get_msg_names() -> ['eventssidecar.v1.AuthOnRegister', 'google.protobuf.Timestamp'].

get_group_names() -> [].

get_msg_or_group_names() -> ['eventssidecar.v1.AuthOnRegister', 'google.protobuf.Timestamp'].
...
find_msg_def('eventssidecar.v1.AuthOnRegister') ->
    [
        #field{
            name = timestamp,
            fnum = 1,
...
fqbin_to_msg_name(<<"eventssidecar.v1.AuthOnRegister">>) -> 'eventssidecar.v1.AuthOnRegister';
fqbin_to_msg_name(<<"google.protobuf.Timestamp">>) -> 'google.protobuf.Timestamp';
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).

msg_name_to_fqbin('eventssidecar.v1.AuthOnRegister') -> <<"eventssidecar.v1.AuthOnRegister">>;
...
source_basename() -> "auth_on_register.proto".
...
get_all_source_basenames() -> ["auth_on_register.proto", "timestamp.proto"].
...
%% functions.
get_all_proto_names() -> ["auth_on_register", "timestamp"].

get_msg_containment("auth_on_register") -> ['eventssidecar.v1.AuthOnRegister'];
get_msg_containment("timestamp") -> ['google.protobuf.Timestamp'];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).

get_pkg_containment("auth_on_register") -> 'eventssidecar.v1';
get_pkg_containment("timestamp") -> 'google.protobuf';
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).

get_service_containment("auth_on_register") -> [];
get_service_containment("timestamp") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).

get_rpc_containment("auth_on_register") -> [];
get_rpc_containment("timestamp") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).

get_enum_containment("auth_on_register") -> [];
get_enum_containment("timestamp") -> [];
get_enum_containment(P) -> error({gpb_error, {badproto, P}}).

get_proto_by_msg_name_as_fqbin(<<"google.protobuf.Timestamp">>) -> "timestamp";
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.AuthOnRegister">>) -> "auth_on_register";
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["auth_on_register"];
