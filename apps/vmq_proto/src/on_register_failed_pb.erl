...
-export([
    'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'/1,
    'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'/1
]).
...
-include("on_register_failed_pb.hrl").
-include("gpb.hrl").

%% enumerated types
-type 'eventssidecar.v1.RegistrationFailureReason'() ::
    'REASON_UNSPECIFIED'
...
%% message types
-type 'eventssidecar.v1.OnRegisterFailed'() :: #'eventssidecar.v1.OnRegisterFailed'{}.

-type 'google.protobuf.Timestamp'() :: #'google.protobuf.Timestamp'{}.

-export_type(['eventssidecar.v1.OnRegisterFailed'/0, 'google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'eventssidecar.v1.OnRegisterFailed' | 'google.protobuf.Timestamp'.
-type '$msg'() :: 'eventssidecar.v1.OnRegisterFailed'() | 'google.protobuf.Timestamp'().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnRegisterFailed' ->
            'encode_msg_eventssidecar.v1.OnRegisterFailed'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
            'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.

'encode_msg_eventssidecar.v1.OnRegisterFailed'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnRegisterFailed'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnRegisterFailed'(
    #'eventssidecar.v1.OnRegisterFailed'{
        timestamp = F1,
        mountpoint = F2,
        client_id = F3,
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnRegisterFailed_timestamp'(
    ...
    if
        ...
        true ->
            begin
                ...
                if
                    TrF8 =:= 'REASON_UNSPECIFIED'; TrF8 =:= 0 ->
                        B7;
                    true ->
                        'e_enum_eventssidecar.v1.RegistrationFailureReason'(
                            TrF8, <<B7/binary, 64>>, TrUserData
                        )
                end
            end
    end.
...
'e_mfield_eventssidecar.v1.OnRegisterFailed_timestamp'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_google.protobuf.Timestamp'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_UNSPECIFIED', Bin, _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_NO_MATCHING_HOOK_FOUND', Bin, _TrUserData
) ->
    <<Bin/binary, 1>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_INVALID_CREDENTIALS', Bin, _TrUserData) ->
    <<Bin/binary, 2>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_NOT_AUTHORIZED', Bin, _TrUserData) ->
    <<Bin/binary, 3>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_STALE_REQUEST', Bin, _TrUserData) ->
    <<Bin/binary, 4>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_INVALID_SIGNATURE', Bin, _TrUserData) ->
    <<Bin/binary, 5>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_USERNAME_RID_MISMATCH', Bin, _TrUserData
) ->
    <<Bin/binary, 6>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_MISSING_RID', Bin, _TrUserData) ->
    <<Bin/binary, 7>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_RATE_LIMIT_EXCEEDED', Bin, _TrUserData) ->
    <<Bin/binary, 8>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_WILL_NOT_AUTHORIZED', Bin, _TrUserData) ->
    <<Bin/binary, 9>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_REGISTRATION_RETRY_EXHAUSTED', Bin, _TrUserData
) ->
    <<Bin/binary, 10>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_REGISTRATION_SYNC_FAILED', Bin, _TrUserData
) ->
    <<Bin/binary, 11>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_STATE_STORE_ERROR', Bin, _TrUserData) ->
    <<Bin/binary, 12>>;
'e_enum_eventssidecar.v1.RegistrationFailureReason'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).
...
decode_msg_2_doit('eventssidecar.v1.OnRegisterFailed', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnRegisterFailed'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnRegisterFailed'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    ...
    'd_field_eventssidecar.v1.OnRegisterFailed_timestamp'(
...
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    ...
    'd_field_eventssidecar.v1.OnRegisterFailed_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<34, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_peer_addr'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<40, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_peer_port'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<50, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_username'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<56, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_clean_session'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    <<64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
) ->
    'd_field_eventssidecar.v1.OnRegisterFailed_reason'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
...
'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    ...
    'dg_read_field_def_eventssidecar.v1.OnRegisterFailed'(
        Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8, TrUserData
    ).
...
'dg_read_field_def_eventssidecar.v1.OnRegisterFailed'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_eventssidecar.v1.OnRegisterFailed'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                1 ->
                    'skip_64_eventssidecar.v1.OnRegisterFailed'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                2 ->
                    'skip_length_delimited_eventssidecar.v1.OnRegisterFailed'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                3 ->
                    'skip_group_eventssidecar.v1.OnRegisterFailed'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
                ...
                5 ->
                    'skip_32_eventssidecar.v1.OnRegisterFailed'(
                        Rest,
                        0,
                        0,
                        Key bsr 3,
...
'd_field_eventssidecar.v1.OnRegisterFailed_reason'(
    <<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, _, TrUserData
) ->
    {NewFValue, RestF} = {
        id(
            'd_enum_eventssidecar.v1.RegistrationFailureReason'(begin
                <<Res:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>,
                id(Res, TrUserData)
            end),
            TrUserData
    ...
    'dfp_read_field_def_eventssidecar.v1.OnRegisterFailed'(
        RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, NewFValue, TrUserData
    ).
...
'd_enum_eventssidecar.v1.RegistrationFailureReason'(0) -> 'REASON_UNSPECIFIED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(1) -> 'REASON_NO_MATCHING_HOOK_FOUND';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(2) -> 'REASON_INVALID_CREDENTIALS';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(3) -> 'REASON_NOT_AUTHORIZED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(4) -> 'REASON_STALE_REQUEST';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(5) -> 'REASON_INVALID_SIGNATURE';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(6) -> 'REASON_USERNAME_RID_MISMATCH';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(7) -> 'REASON_MISSING_RID';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(8) -> 'REASON_RATE_LIMIT_EXCEEDED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(9) -> 'REASON_WILL_NOT_AUTHORIZED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(10) -> 'REASON_REGISTRATION_RETRY_EXHAUSTED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(11) -> 'REASON_REGISTRATION_SYNC_FAILED';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(12) -> 'REASON_STATE_STORE_ERROR';
'd_enum_eventssidecar.v1.RegistrationFailureReason'(V) -> V.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnRegisterFailed' ->
            'merge_msg_eventssidecar.v1.OnRegisterFailed'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
            'merge_msg_google.protobuf.Timestamp'(Prev, New, TrUserData)
    end.

-compile({nowarn_unused_function, 'merge_msg_eventssidecar.v1.OnRegisterFailed'/3}).
'merge_msg_eventssidecar.v1.OnRegisterFailed'(
    #'eventssidecar.v1.OnRegisterFailed'{
    ...
    #'eventssidecar.v1.OnRegisterFailed'{
        ...
        clean_session =
            if
                NFclean_session =:= undefined -> PFclean_session;
                true -> NFclean_session
            end,
        reason =
            if
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnRegisterFailed' ->
            'v_msg_eventssidecar.v1.OnRegisterFailed'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
-compile({nowarn_unused_function, 'v_msg_eventssidecar.v1.OnRegisterFailed'/3}).
-dialyzer({nowarn_function, 'v_msg_eventssidecar.v1.OnRegisterFailed'/3}).
'v_msg_eventssidecar.v1.OnRegisterFailed'(
    #'eventssidecar.v1.OnRegisterFailed'{
        timestamp = F1,
        mountpoint = F2,
        client_id = F3,
    ...
    if
        F4 == undefined -> ok;
        true -> v_type_string(F4, [peer_addr | Path], TrUserData)
    end,
    if
        F5 == undefined -> ok;
        true -> v_type_int32(F5, [peer_port | Path], TrUserData)
    end,
    if
        F6 == undefined -> ok;
        true -> v_type_string(F6, [username | Path], TrUserData)
    end,
    if
        F7 == undefined -> ok;
        true -> v_type_bool(F7, [clean_session | Path], TrUserData)
    end,
    if
        F8 == undefined -> ok;
        true -> 'v_enum_eventssidecar.v1.RegistrationFailureReason'(F8, [reason | Path], TrUserData)
    end,
    ok;
'v_msg_eventssidecar.v1.OnRegisterFailed'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.OnRegisterFailed'}, X, Path).
...
-compile({nowarn_unused_function, 'v_enum_eventssidecar.v1.RegistrationFailureReason'/3}).
-dialyzer({nowarn_function, 'v_enum_eventssidecar.v1.RegistrationFailureReason'/3}).
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_UNSPECIFIED', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_NO_MATCHING_HOOK_FOUND', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_INVALID_CREDENTIALS', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_NOT_AUTHORIZED', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_STALE_REQUEST', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_INVALID_SIGNATURE', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_USERNAME_RID_MISMATCH', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_MISSING_RID', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_RATE_LIMIT_EXCEEDED', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_WILL_NOT_AUTHORIZED', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_REGISTRATION_RETRY_EXHAUSTED', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_REGISTRATION_SYNC_FAILED', _Path, _TrUserData
) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'('REASON_STATE_STORE_ERROR', _Path, _TrUserData) ->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(V, _Path, _TrUserData) when
    -2147483648 =< V, V =< 2147483647, is_integer(V)
->
    ok;
'v_enum_eventssidecar.v1.RegistrationFailureReason'(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'eventssidecar.v1.RegistrationFailureReason'}, X, Path).
...
get_msg_defs() ->
    [
        {{enum, 'eventssidecar.v1.RegistrationFailureReason'}, [
            ...
            {'REASON_MISSING_RID', 7},
            {'REASON_RATE_LIMIT_EXCEEDED', 8},
            {'REASON_WILL_NOT_AUTHORIZED', 9},
            {'REASON_REGISTRATION_RETRY_EXHAUSTED', 10},
            {'REASON_REGISTRATION_SYNC_FAILED', 11},
            {'REASON_STATE_STORE_ERROR', 12}
        ]},
        {{msg, 'eventssidecar.v1.OnRegisterFailed'}, [
            #field{
                name = timestamp,
                fnum = 1,
                rnum = 2,
            ...
            #field{
                name = peer_port, fnum = 5, rnum = 6, type = int32, occurrence = optional, opts = []
            },
            #field{
                name = username, fnum = 6, rnum = 7, type = string, occurrence = optional, opts = []
            },
            #field{
                name = clean_session,
                fnum = 7,
            ...
            #field{
                ...
                fnum = 8,
                rnum = 9,
                type = {enum, 'eventssidecar.v1.RegistrationFailureReason'},
                occurrence = optional,
                opts = []
            }
        ]},
...
get_msg_names() -> ['eventssidecar.v1.OnRegisterFailed', 'google.protobuf.Timestamp'].

get_group_names() -> [].

get_msg_or_group_names() -> ['eventssidecar.v1.OnRegisterFailed', 'google.protobuf.Timestamp'].

get_enum_names() -> ['eventssidecar.v1.RegistrationFailureReason'].
...
find_msg_def('eventssidecar.v1.OnRegisterFailed') ->
    [
        #field{
            name = timestamp,
            fnum = 1,
        ...
        #field{
            name = mountpoint, fnum = 2, rnum = 3, type = string, occurrence = optional, opts = []
        },
        #field{
        ...
        #field{
            name = clean_session, fnum = 7, rnum = 8, type = bool, occurrence = optional, opts = []
        },
        #field{
            name = reason,
            fnum = 8,
...
find_enum_def('eventssidecar.v1.RegistrationFailureReason') ->
    [
        {'REASON_UNSPECIFIED', 0},
        {'REASON_NO_MATCHING_HOOK_FOUND', 1},
        {'REASON_INVALID_CREDENTIALS', 2},
...
enum_symbol_by_value('eventssidecar.v1.RegistrationFailureReason', Value) ->
    'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(Value).

enum_value_by_symbol('eventssidecar.v1.RegistrationFailureReason', Sym) ->
    'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'(Sym).

'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(0) ->
    'REASON_UNSPECIFIED';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(1) ->
    'REASON_NO_MATCHING_HOOK_FOUND';
...
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(6) ->
    'REASON_USERNAME_RID_MISMATCH';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(7) ->
    'REASON_MISSING_RID';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(8) ->
    'REASON_RATE_LIMIT_EXCEEDED';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(9) ->
    'REASON_WILL_NOT_AUTHORIZED';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(10) ->
    'REASON_REGISTRATION_RETRY_EXHAUSTED';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(11) ->
    'REASON_REGISTRATION_SYNC_FAILED';
'enum_symbol_by_value_eventssidecar.v1.RegistrationFailureReason'(12) ->
    'REASON_STATE_STORE_ERROR'.

'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_UNSPECIFIED') ->
    0;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_NO_MATCHING_HOOK_FOUND') ->
    1;
...
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_USERNAME_RID_MISMATCH') ->
    6;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_MISSING_RID') ->
    7;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_RATE_LIMIT_EXCEEDED') ->
    8;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_WILL_NOT_AUTHORIZED') ->
    9;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'(
    'REASON_REGISTRATION_RETRY_EXHAUSTED'
) ->
    10;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'(
    ...
    11;
'enum_value_by_symbol_eventssidecar.v1.RegistrationFailureReason'('REASON_STATE_STORE_ERROR') ->
    12.
...
fqbin_to_msg_name(<<"eventssidecar.v1.OnRegisterFailed">>) -> 'eventssidecar.v1.OnRegisterFailed';
fqbin_to_msg_name(<<"google.protobuf.Timestamp">>) -> 'google.protobuf.Timestamp';
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).

msg_name_to_fqbin('eventssidecar.v1.OnRegisterFailed') -> <<"eventssidecar.v1.OnRegisterFailed">>;
msg_name_to_fqbin('google.protobuf.Timestamp') -> <<"google.protobuf.Timestamp">>;
msg_name_to_fqbin(E) -> error({gpb_error, {badmsg, E}}).

fqbin_to_enum_name(<<"eventssidecar.v1.RegistrationFailureReason">>) ->
    'eventssidecar.v1.RegistrationFailureReason';
fqbin_to_enum_name(E) ->
    error({gpb_error, {badenum, E}}).

enum_name_to_fqbin('eventssidecar.v1.RegistrationFailureReason') ->
    <<"eventssidecar.v1.RegistrationFailureReason">>;
...
source_basename() -> "on_register_failed.proto".
...
get_all_source_basenames() ->
    ["on_register_failed.proto", "timestamp.proto", "registration_failure_reason.proto"].
...
%% functions.
get_all_proto_names() -> ["on_register_failed", "timestamp", "registration_failure_reason"].

get_msg_containment("on_register_failed") -> ['eventssidecar.v1.OnRegisterFailed'];
get_msg_containment("timestamp") -> ['google.protobuf.Timestamp'];
get_msg_containment("registration_failure_reason") -> [];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).

get_pkg_containment("on_register_failed") -> 'eventssidecar.v1';
get_pkg_containment("timestamp") -> 'google.protobuf';
get_pkg_containment("registration_failure_reason") -> 'eventssidecar.v1';
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).

get_service_containment("on_register_failed") -> [];
get_service_containment("timestamp") -> [];
get_service_containment("registration_failure_reason") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).

get_rpc_containment("on_register_failed") -> [];
get_rpc_containment("timestamp") -> [];
get_rpc_containment("registration_failure_reason") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).

get_enum_containment("on_register_failed") ->
    [];
get_enum_containment("timestamp") ->
    [];
get_enum_containment("registration_failure_reason") ->
    ['eventssidecar.v1.RegistrationFailureReason'];
get_enum_containment(P) ->
    error({gpb_error, {badproto, P}}).

get_proto_by_msg_name_as_fqbin(<<"google.protobuf.Timestamp">>) -> "timestamp";
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.OnRegisterFailed">>) -> "on_register_failed";
get_proto_by_msg_name_as_fqbin(E) -> error({gpb_error, {badmsg, E}}).

-spec get_proto_by_service_name_as_fqbin(_) -> no_return().
get_proto_by_service_name_as_fqbin(E) -> error({gpb_error, {badservice, E}}).

get_proto_by_enum_name_as_fqbin(<<"eventssidecar.v1.RegistrationFailureReason">>) ->
    "registration_failure_reason";
get_proto_by_enum_name_as_fqbin(E) ->
    error({gpb_error, {badenum, E}}).

get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) ->
    ["on_register_failed", "registration_failure_reason"];
