...
%% Version source: file
-module(registration_failure_reason_pb).
...
-include("registration_failure_reason_pb.hrl").
-include("gpb.hrl").
...
source_basename() -> "registration_failure_reason.proto".
...
get_all_source_basenames() -> ["registration_failure_reason.proto"].
...
%% functions.
get_all_proto_names() -> ["registration_failure_reason"].
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["registration_failure_reason"];
