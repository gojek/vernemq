...
-export(['enum_symbol_by_value_eventssidecar.v1.Reason'/1, 'enum_value_by_symbol_eventssidecar.v1.Reason'/1]).
...
-include("on_client_gone_pb.hrl").
-include("gpb.hrl").

%% enumerated types
-type 'eventssidecar.v1.Reason'() :: 'REASON_UNSPECIFIED' | 'REASON_NOT_AUTHORIZED' | 'REASON_NORMAL_DISCONNECT' | 'REASON_SESSION_TAKEN_OVER' | 'REASON_ADMINISTRATIVE_ACTION' | 'REASON_DISCONNECT_KEEP_ALIVE' | 'REASON_DISCONNECT_MIGRATION' | 'REASON_BAD_AUTHENTICATION_METHOD' | 'REASON_REMOTE_SESSION_TAKEN_OVER' | 'REASON_MQTT_CLIENT_DISCONNECT' | 'REASON_RECEIVE_MAX_EXCEEDED' | 'REASON_PROTOCOL_ERROR' | 'REASON_PUBLISH_AUTH_ERROR' | 'REASON_INVALID_PUBREC_ERROR' | 'REASON_INVALID_PUBCOMP_ERROR' | 'REASON_UNEXPECTED_FRAME_TYPE' | 'REASON_EXIT_SIGNAL_RECEIVED' | 'REASON_TCP_CLOSED'.
-export_type(['eventssidecar.v1.Reason'/0]).

%% message types
-type 'eventssidecar.v1.OnClientGone'() :: #'eventssidecar.v1.OnClientGone'{}.

-type 'google.protobuf.Timestamp'() :: #'google.protobuf.Timestamp'{}.

-export_type(['eventssidecar.v1.OnClientGone'/0, 'google.protobuf.Timestamp'/0]).
-type '$msg_name'() :: 'eventssidecar.v1.OnClientGone' | 'google.protobuf.Timestamp'.
-type '$msg'() :: 'eventssidecar.v1.OnClientGone'() | 'google.protobuf.Timestamp'().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientGone' -> 'encode_msg_eventssidecar.v1.OnClientGone'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' -> 'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.


'encode_msg_eventssidecar.v1.OnClientGone'(Msg, TrUserData) -> 'encode_msg_eventssidecar.v1.OnClientGone'(Msg, <<>>, TrUserData).


'encode_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3, reason = F4, username = F5}, Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
            true ->
                begin
                    TrF1 = id(F1, TrUserData),
                    if TrF1 =:= undefined -> Bin;
                       true -> 'e_mfield_eventssidecar.v1.OnClientGone_timestamp'(TrF1, <<Bin/binary, 10>>, TrUserData)
                    end
                end
         end,
    ...
    B4 = if F4 == undefined -> B3;
            true ->
                begin
                    ...
                    if TrF4 =:= 'REASON_UNSPECIFIED'; TrF4 =:= 0 -> B3;
...
'e_mfield_eventssidecar.v1.OnClientGone_timestamp'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_google.protobuf.Timestamp'(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_enum_eventssidecar.v1.Reason'('REASON_UNSPECIFIED', Bin, _TrUserData) -> <<Bin/binary, 0>>;
'e_enum_eventssidecar.v1.Reason'('REASON_NOT_AUTHORIZED', Bin, _TrUserData) -> <<Bin/binary, 1>>;
'e_enum_eventssidecar.v1.Reason'('REASON_NORMAL_DISCONNECT', Bin, _TrUserData) -> <<Bin/binary, 2>>;
'e_enum_eventssidecar.v1.Reason'('REASON_SESSION_TAKEN_OVER', Bin, _TrUserData) -> <<Bin/binary, 3>>;
'e_enum_eventssidecar.v1.Reason'('REASON_ADMINISTRATIVE_ACTION', Bin, _TrUserData) -> <<Bin/binary, 4>>;
'e_enum_eventssidecar.v1.Reason'('REASON_DISCONNECT_KEEP_ALIVE', Bin, _TrUserData) -> <<Bin/binary, 5>>;
'e_enum_eventssidecar.v1.Reason'('REASON_DISCONNECT_MIGRATION', Bin, _TrUserData) -> <<Bin/binary, 6>>;
'e_enum_eventssidecar.v1.Reason'('REASON_BAD_AUTHENTICATION_METHOD', Bin, _TrUserData) -> <<Bin/binary, 7>>;
'e_enum_eventssidecar.v1.Reason'('REASON_REMOTE_SESSION_TAKEN_OVER', Bin, _TrUserData) -> <<Bin/binary, 8>>;
'e_enum_eventssidecar.v1.Reason'('REASON_MQTT_CLIENT_DISCONNECT', Bin, _TrUserData) -> <<Bin/binary, 9>>;
'e_enum_eventssidecar.v1.Reason'('REASON_RECEIVE_MAX_EXCEEDED', Bin, _TrUserData) -> <<Bin/binary, 10>>;
'e_enum_eventssidecar.v1.Reason'('REASON_PROTOCOL_ERROR', Bin, _TrUserData) -> <<Bin/binary, 11>>;
'e_enum_eventssidecar.v1.Reason'('REASON_PUBLISH_AUTH_ERROR', Bin, _TrUserData) -> <<Bin/binary, 12>>;
'e_enum_eventssidecar.v1.Reason'('REASON_INVALID_PUBREC_ERROR', Bin, _TrUserData) -> <<Bin/binary, 13>>;
'e_enum_eventssidecar.v1.Reason'('REASON_INVALID_PUBCOMP_ERROR', Bin, _TrUserData) -> <<Bin/binary, 14>>;
'e_enum_eventssidecar.v1.Reason'('REASON_UNEXPECTED_FRAME_TYPE', Bin, _TrUserData) -> <<Bin/binary, 15>>;
'e_enum_eventssidecar.v1.Reason'('REASON_EXIT_SIGNAL_RECEIVED', Bin, _TrUserData) -> <<Bin/binary, 16>>;
'e_enum_eventssidecar.v1.Reason'('REASON_TCP_CLOSED', Bin, _TrUserData) -> <<Bin/binary, 17>>;
'e_enum_eventssidecar.v1.Reason'(V, Bin, _TrUserData) -> e_varint(V, Bin).
...
decode_msg_2_doit('eventssidecar.v1.OnClientGone', Bin, TrUserData) -> id('decode_msg_eventssidecar.v1.OnClientGone'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnClientGone'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Bin, 0, 0, 0, id(undefined, TrUserData), id(<<>>, TrUserData), id(<<>>, TrUserData), id('REASON_UNSPECIFIED', TrUserData), id(<<>>, TrUserData), TrUserData).

'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<10, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_reason'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<42, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'd_field_eventssidecar.v1.OnClientGone_username'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, _) -> #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, reason = F@_4, username = F@_5};
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'dg_read_field_def_eventssidecar.v1.OnClientGone'(Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).

'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 32 - 7 ->
    'dg_read_field_def_eventssidecar.v1.OnClientGone'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<0:1, X:7, Rest/binary>>, N, Acc, _, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        10 -> 'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
        18 -> 'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
        26 -> 'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
        32 -> 'd_field_eventssidecar.v1.OnClientGone_reason'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
        42 -> 'd_field_eventssidecar.v1.OnClientGone_username'(Rest, 0, 0, 0, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
        _ ->
            case Key band 7 of
                0 -> 'skip_varint_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
                1 -> 'skip_64_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
                2 -> 'skip_length_delimited_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
                3 -> 'skip_group_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
                5 -> 'skip_32_eventssidecar.v1.OnClientGone'(Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, _) -> #'eventssidecar.v1.OnClientGone'{timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, reason = F@_4, username = F@_5}.

'd_field_eventssidecar.v1.OnClientGone_timestamp'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnClientGone_timestamp'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_timestamp'(<<0:1, X:7, Rest/binary>>, N, Acc, F, Prev, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    ...
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF,
                                                       0,
                                                       0,
                                                       F,
...
'd_field_eventssidecar.v1.OnClientGone_client_id'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnClientGone_client_id'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_client_id'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, _, F@_3, F@_4, F@_5, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, NewFValue, F@_3, F@_4, F@_5, TrUserData).

'd_field_eventssidecar.v1.OnClientGone_mountpoint'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnClientGone_mountpoint'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_mountpoint'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, _, F@_4, F@_5, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, F@_2, NewFValue, F@_4, F@_5, TrUserData).

'd_field_eventssidecar.v1.OnClientGone_reason'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnClientGone_reason'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_reason'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, _, F@_5, TrUserData) ->
    {NewFValue, RestF} = {id('d_enum_eventssidecar.v1.Reason'(begin <<Res:32/signed-native>> = <<(X bsl N + Acc):32/unsigned-native>>, id(Res, TrUserData) end), TrUserData), Rest},
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, F@_2, F@_3, NewFValue, F@_5, TrUserData).

'd_field_eventssidecar.v1.OnClientGone_username'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'd_field_eventssidecar.v1.OnClientGone_username'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'd_field_eventssidecar.v1.OnClientGone_username'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, _, TrUserData) ->
    {NewFValue, RestF} = begin Len = X bsl N + Acc, <<Bytes:Len/binary, Rest2/binary>> = Rest, Bytes2 = binary:copy(Bytes), {id(Bytes2, TrUserData), Rest2} end,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(RestF, 0, 0, F, F@_1, F@_2, F@_3, F@_4, NewFValue, TrUserData).

'skip_varint_eventssidecar.v1.OnClientGone'(<<1:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'skip_varint_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'skip_varint_eventssidecar.v1.OnClientGone'(<<0:1, _:7, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).

'skip_length_delimited_eventssidecar.v1.OnClientGone'(<<1:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) when N < 57 ->
    'skip_length_delimited_eventssidecar.v1.OnClientGone'(Rest, N + 7, X bsl N + Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData);
'skip_length_delimited_eventssidecar.v1.OnClientGone'(<<0:1, X:7, Rest/binary>>, N, Acc, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest2, 0, 0, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).

'skip_group_eventssidecar.v1.OnClientGone'(Bin, _, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, 0, Z2, FNum, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).

'skip_32_eventssidecar.v1.OnClientGone'(<<_:32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).

'skip_64_eventssidecar.v1.OnClientGone'(<<_:64, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) -> 'dfp_read_field_def_eventssidecar.v1.OnClientGone'(Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        'eventssidecar.v1.OnClientGone' -> 'merge_msg_eventssidecar.v1.OnClientGone'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' -> 'merge_msg_google.protobuf.Timestamp'(Prev, New, TrUserData)
    end.

-compile({nowarn_unused_function,'merge_msg_eventssidecar.v1.OnClientGone'/3}).
'merge_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = PFtimestamp, client_id = PFclient_id, mountpoint = PFmountpoint, reason = PFreason, username = PFusername},
                                          #'eventssidecar.v1.OnClientGone'{timestamp = NFtimestamp, client_id = NFclient_id, mountpoint = NFmountpoint, reason = NFreason, username = NFusername}, TrUserData) ->
    #'eventssidecar.v1.OnClientGone'{timestamp =
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        'eventssidecar.v1.OnClientGone' -> 'v_msg_eventssidecar.v1.OnClientGone'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' -> 'v_msg_google.protobuf.Timestamp'(Msg, [MsgName], TrUserData);
        _ -> mk_type_error(not_a_known_message, Msg, [])
    end.


-compile({nowarn_unused_function,'v_msg_eventssidecar.v1.OnClientGone'/3}).
-dialyzer({nowarn_function,'v_msg_eventssidecar.v1.OnClientGone'/3}).
'v_msg_eventssidecar.v1.OnClientGone'(#'eventssidecar.v1.OnClientGone'{timestamp = F1, client_id = F2, mountpoint = F3, reason = F4, username = F5}, Path, TrUserData) ->
    if F1 == undefined -> ok;
    ...
    ok;
'v_msg_eventssidecar.v1.OnClientGone'(X, Path, _TrUserData) -> mk_type_error({expected_msg, 'eventssidecar.v1.OnClientGone'}, X, Path).
...
'v_enum_eventssidecar.v1.Reason'('REASON_UNSPECIFIED', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_NOT_AUTHORIZED', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_NORMAL_DISCONNECT', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_SESSION_TAKEN_OVER', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_ADMINISTRATIVE_ACTION', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_DISCONNECT_KEEP_ALIVE', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_DISCONNECT_MIGRATION', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_BAD_AUTHENTICATION_METHOD', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_REMOTE_SESSION_TAKEN_OVER', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_MQTT_CLIENT_DISCONNECT', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_RECEIVE_MAX_EXCEEDED', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_PROTOCOL_ERROR', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_PUBLISH_AUTH_ERROR', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_INVALID_PUBREC_ERROR', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_INVALID_PUBCOMP_ERROR', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_UNEXPECTED_FRAME_TYPE', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_EXIT_SIGNAL_RECEIVED', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'('REASON_TCP_CLOSED', _Path, _TrUserData) -> ok;
'v_enum_eventssidecar.v1.Reason'(V, _Path, _TrUserData) when -2147483648 =< V, V =< 2147483647, is_integer(V) -> ok;
'v_enum_eventssidecar.v1.Reason'(X, Path, _TrUserData) -> mk_type_error({invalid_enum, 'eventssidecar.v1.Reason'}, X, Path).
    ...
    [{{enum, 'eventssidecar.v1.Reason'},
     ...
     {{msg, 'eventssidecar.v1.OnClientGone'},
      [#field{name = timestamp, fnum = 1, rnum = 2, type = {msg, 'google.protobuf.Timestamp'}, occurrence = optional, opts = []},
       ...
       #field{name = reason, fnum = 4, rnum = 5, type = {enum, 'eventssidecar.v1.Reason'}, occurrence = optional, opts = []},
...
get_msg_names() -> ['eventssidecar.v1.OnClientGone', 'google.protobuf.Timestamp'].


get_group_names() -> [].


get_msg_or_group_names() -> ['eventssidecar.v1.OnClientGone', 'google.protobuf.Timestamp'].
...
find_msg_def('eventssidecar.v1.OnClientGone') ->
    [#field{name = timestamp, fnum = 1, rnum = 2, type = {msg, 'google.protobuf.Timestamp'}, occurrence = optional, opts = []},
     #field{name = client_id, fnum = 2, rnum = 3, type = string, occurrence = optional, opts = []},
     #field{name = mountpoint, fnum = 3, rnum = 4, type = string, occurrence = optional, opts = []},
     #field{name = reason, fnum = 4, rnum = 5, type = {enum, 'eventssidecar.v1.Reason'}, occurrence = optional, opts = []},
...
enum_symbol_by_value('eventssidecar.v1.Reason', Value) -> 'enum_symbol_by_value_eventssidecar.v1.Reason'(Value).


enum_value_by_symbol('eventssidecar.v1.Reason', Sym) -> 'enum_value_by_symbol_eventssidecar.v1.Reason'(Sym).
...
fqbin_to_msg_name(<<"eventssidecar.v1.OnClientGone">>) -> 'eventssidecar.v1.OnClientGone';
fqbin_to_msg_name(<<"google.protobuf.Timestamp">>) -> 'google.protobuf.Timestamp';
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin('eventssidecar.v1.OnClientGone') -> <<"eventssidecar.v1.OnClientGone">>;
...
source_basename() -> "on_client_gone.proto".
...
get_all_source_basenames() -> ["on_client_gone.proto", "timestamp.proto", "disconnect_reason.proto"].
...
get_proto_by_msg_name_as_fqbin(<<"eventssidecar.v1.OnClientGone">>) -> "on_client_gone";
...
get_protos_by_pkg_name_as_fqbin(<<"eventssidecar.v1">>) -> ["disconnect_reason", "on_client_gone"];
