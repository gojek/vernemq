...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientGone' ->
            'encode_msg_eventssidecar.v1.OnClientGone'(id(Msg, TrUserData), TrUserData);
        'google.protobuf.Timestamp' ->
            'encode_msg_google.protobuf.Timestamp'(id(Msg, TrUserData), TrUserData)
    end.

'encode_msg_eventssidecar.v1.OnClientGone'(Msg, TrUserData) ->
    'encode_msg_eventssidecar.v1.OnClientGone'(Msg, <<>>, TrUserData).

'encode_msg_eventssidecar.v1.OnClientGone'(
    #'eventssidecar.v1.OnClientGone'{
                ...
                begin
                    ...
                    if
                        TrF1 =:= undefined ->
                            Bin;
                        true ->
                            'e_mfield_eventssidecar.v1.OnClientGone_timestamp'(
                ...
                begin
                    ...
                    if
                        TrF4 =:= 'REASON_UNSPECIFIED'; TrF4 =:= 0 ->
                            B3;
                        true ->
                            'e_enum_eventssidecar.v1.Reason'(TrF4, <<B3/binary, 32>>, TrUserData)
                    end
                end
        end,
    if
...
decode_msg_2_doit('eventssidecar.v1.OnClientGone', Bin, TrUserData) ->
    id('decode_msg_eventssidecar.v1.OnClientGone'(Bin, TrUserData), TrUserData);
...
'decode_msg_eventssidecar.v1.OnClientGone'(Bin, TrUserData) ->
    'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
        Bin,
        0,
        0,
        0,
...
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    ...
    'd_field_eventssidecar.v1.OnClientGone_timestamp'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    <<18, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientGone_client_id'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    <<26, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientGone_mountpoint'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    <<32, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientGone_reason'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    <<42, Rest/binary>>, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
) ->
    'd_field_eventssidecar.v1.OnClientGone_username'(
        Rest, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    );
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #'eventssidecar.v1.OnClientGone'{
...
'dfp_read_field_def_eventssidecar.v1.OnClientGone'(
    ...
    'dg_read_field_def_eventssidecar.v1.OnClientGone'(
        Other, Z1, Z2, F, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
    ).
...
'dg_read_field_def_eventssidecar.v1.OnClientGone'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_eventssidecar.v1.OnClientGone'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
                    );
                1 ->
                    'skip_64_eventssidecar.v1.OnClientGone'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
                    );
                2 ->
                    'skip_length_delimited_eventssidecar.v1.OnClientGone'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
                    );
                3 ->
                    'skip_group_eventssidecar.v1.OnClientGone'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
                    );
                5 ->
                    'skip_32_eventssidecar.v1.OnClientGone'(
                        Rest, 0, 0, Key bsr 3, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData
                    )
            end
    end;
'dg_read_field_def_eventssidecar.v1.OnClientGone'(<<>>, 0, 0, _, F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #'eventssidecar.v1.OnClientGone'{
        timestamp = F@_1, client_id = F@_2, mountpoint = F@_3, reason = F@_4, username = F@_5
    }.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientGone' ->
            'merge_msg_eventssidecar.v1.OnClientGone'(Prev, New, TrUserData);
        'google.protobuf.Timestamp' ->
...
'merge_msg_eventssidecar.v1.OnClientGone'(
    #'eventssidecar.v1.OnClientGone'{
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        'eventssidecar.v1.OnClientGone' ->
            'v_msg_eventssidecar.v1.OnClientGone'(Msg, [MsgName], TrUserData);
        'google.protobuf.Timestamp' ->
...
'v_msg_eventssidecar.v1.OnClientGone'(
    #'eventssidecar.v1.OnClientGone'{
        timestamp = F1, client_id = F2, mountpoint = F3, reason = F4, username = F5
    },
    Path,
    ...
    ok;
'v_msg_eventssidecar.v1.OnClientGone'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eventssidecar.v1.OnClientGone'}, X, Path).
...
get_all_source_basenames() ->
    ["on_client_gone.proto", "timestamp.proto", "disconnect_reason.proto"].
